...
print("loading model form ", os.path.join(args.pretrained_dir,'model_checkpoint.pth'))
...
train_sat_global_descriptor = np.zeros([34224, 768])
train_grd_global_descriptor = np.zeros([34224, 768])

test_sat_global_descriptor = np.zeros([3802, 768])
test_grd_global_descriptor = np.zeros([3802, 768])
val_i =0
