...
train_sat_global_descriptor = np.zeros([17061, 768])
train_grd_global_descriptor = np.zeros([17061, 768])

test_sat_global_descriptor = np.zeros([1895, 768])
test_grd_global_descriptor = np.zeros([1895, 768])
val_i =0
