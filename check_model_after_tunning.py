...
train_sat_global_descriptor = np.zeros([17060, 768])
train_grd_global_descriptor = np.zeros([17060, 768])

test_sat_global_descriptor = np.zeros([1896, 768])
test_grd_global_descriptor = np.zeros([1896, 768])
val_i =0
